...
d3.json("../static/data/us-venues.json", function(collection) {
...
$('#content').html('<a href=\'javascript:four();\'>→</a>');
  $('#content').append('<h3>Classes Categorized by Skillset</h3>');

  $('svg').css('margin-left', '21%');
  $('h3').css('margin-left', '482px');
});
}
